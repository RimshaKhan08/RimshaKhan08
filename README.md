...
Building production-ready REST APIs with FastAPI — from in-memory CRUD to real database integration with SQLAlchemy
...
Machine Learning (Sklearn) → ML Projects
      ↓
FastAPI Basics → Pydantic Models → SQLAlchemy
      ↓
...
# Current Goals
 ...
 Connect FastAPI projects to PostgreSQL
 Deploy a project to the cloud (Render / Railway)
 Contribute to an open source Python project


📍 Based in Lahore, Pakistan
Open to learning opportunities, collaborations, and feedback on my projects.

 

<!--
**RimshaKhan08/RimshaKhan08** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
